...
from .views import (
    UserRegistrationView, AssociationViewSet, AssociationTypeViewSet, MembreViewSet,
    DocumentViewSet, TypeDocumentViewSet, NotificationViewSet, MandatViewSet, RoleTypeViewSet
)
...
router.register(r'association-types', AssociationTypeViewSet, basename='association-type')
